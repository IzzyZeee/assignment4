...
import { MOVIE_DISCOVER_ENDPOINT, TV_DISCOVER_ENDPOINT, MOVIE_GENRES, TV_GENRES } from '@/core/constants';
import type { GenresResponse, MoviesResponse, TvsResponse } from '@/core/types';
